...
<html>
	...
	<body>
		...
		<div class="table">
			...
			<div class="tbody">
                                <c:forEach items="${listeCodes}" var="code">
                                <form class="tr" method="get">
					<div class="td"><input type="text" name="code" value=${code.key} readonly/></div>
					<div class="td"><input name="taux" type="number" step="0.01" min="0.0" max="99.99" size="5" value=${code.value}/></div>
